...
const NewProduct = () => {
  ...
  return (
    <div className='flex flex-col'>
        ...
        <h1 className=' text-4xl font-bold'>NEW PRODUCT ADD</h1>
        </div>
    <div className='  bg-white flex justify-center h-fit items-start mx-auto w-fit  gap-x-20'>
    <div className='lg:max-w-[650px] max-w-[310px] flex  overflow-hidden rounded-lg shadow-lg mt-[30px] lg:border'>
        <form onSubmit={handleonSubmit}  className=' flex flex-col justify-center items-start w-full gap-y-5 p-10'>
            ...
            <label className='flex flex-col w-full'>
                 ...
                 <input type="text" className=' border-b-2 outline-none border-blue-800 p-0.5 ' onChange={handleonChange} value={Quantity} name='Quantity'/>
             </label>
             <label className='flex flex-col w-full'>
